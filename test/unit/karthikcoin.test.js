const Karthik = artifacts.require("KarthikCoin");
contract("Karthik", accounts => {
    it("should mint 10000 KarthikCoin", async() => {
        const instance = await Karthik.deployed();
    ...
    it("Owner has balance of 10000 KarthikCoin", async() => {
        const instance = await Karthik.deployed();
